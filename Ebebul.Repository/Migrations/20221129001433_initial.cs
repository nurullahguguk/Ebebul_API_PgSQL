        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNum = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    Length = table.Column<int>(type: "integer", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4807), "Ümraniye", 1, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4819), "nurullahguguk@gmail.com", 2, "40282523972", 180, "Beykoz", "Nurullah", "1234", "Guguk", null, "nurullahggk", 102 },
                    { 2, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4821), "Çekmeköy", 2, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4822), "beyzayldrm@gmail.com", 1, "10325523928", 163, "Pendik", "Beyza", "1234", "Yıldırım", null, "beyzayldrm", 65 },
                    { 3, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4823), "Bursa", 3, new DateTime(2022, 11, 29, 3, 14, 33, 57, DateTimeKind.Local).AddTicks(4824), "sencan@gmail.com", 1, "10586954732", 155, "Maltepe", "Sena", "1234", "Can", null, "sencan", 65 }
                });
